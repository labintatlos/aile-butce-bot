...
Aykut ve Aslıhan'ın harcamalarını telefondan ve bilgisayardan kullanıcı adı ve
şifreyle açılan bir web sitesine kaydettiği, kredi kartı taksitlerini ve ekstre
yükünü otomatik hesaplayan aile bütçe takip sistemi. Raspberry Pi 5 üzerinde
Home Assistant OS altında bir add-on olarak çalışır ve Keenetic KeenDNS ile
HTTPS üzerinden internete açılır.

Sürüm notları: [CHANGELOG.md](budget_addon/CHANGELOG.md).
...
- Harcamaları kişi, kategori, ödeme yöntemi ve tarihe göre kaydeder;
  "500 market" gibi hızlı giriş de kabul eder.
...
- Sitede, e-postayla veya telefona anlık bildirim olarak.
...
- **Web sitesi:** kullanıcı adı ve şifreyle; telefon ve bilgisayar uyumlu.
  Kişiler ve şifreler sitenin kendisinden yönetilir.
- **Home Assistant paneli:** aynı arayüz, HA oturumuyla.
- Şifreler yalnızca özet olarak saklanır.
...
| Belge | İçerik |
|---|---|
| [budget_addon/DOCS.md](budget_addon/DOCS.md) | Kurulum, kişiler, kartlar, bildirimler, sorun giderme |
| [docs/DEPLOYMENT_HA.md](docs/DEPLOYMENT_HA.md) | KeenDNS ile HTTPS yayın |
...
| [IMPLEMENTATION_PLAN.md](IMPLEMENTATION_PLAN.md) | İlk mimari plan (tarihsel) |
...
şifreler veritabanında özet olarak, SMTP şifresi ve site adresi yalnızca Home
Assistant add-on ayarlarında saklanır.
...
kur ve başlat. Günlükte yazan kurulum koduyla sitede yönetici hesabını oluştur.
